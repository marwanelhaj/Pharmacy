...
const StudentProfile = (props) => {
  //Validations
  const [fullNameValField, setFullNameValField] = useState(null);
  const [cityValField, setCityValField] = useState(null);
  const [emailValField, setEmailValField] = useState(null);
  ...
  useEffect(() => {
    ...
    let user_profile = props.userDetails
      ? props.userDetails.user_profile
        ? props.userDetails.user_profile
        : profileModel
      : profileModel;
    ...
    user_profile.full_name = fullName ? fullName : user_profile.full_name;
    user_profile.email = email ? email : user_profile.email;
  ...
  const saveProfileInfo = (event) => {
    ...
    let { id, full_name, city, country, email, profile_pic } = profileModel;
    setLoading(true);

    axios
      .post(
        usersUrl + "/create_user_profile",
        {
          id,
          full_name,
          city,
  ...
  const checkProfileInfoValidations = () => {
    ...
    let { full_name, city, email } = profileModel;

    if (!full_name) {
      setFullNameValField("Please Enter Full Name");
      validation = true;
    } else {
      validation = validation === false ? false : true;
      setFullNameValField(null);
    }
    if (!city) {
      setCityValField("Please Enter City");
      validation = true;
    } else {
      validation = validation === false ? false : true;
      setCityValField(null);
    }
    if (!email) {
      setEmailValField("Please Enter Email");
      validation = true;
    } else {
      validation = validation === false ? false : true;
      setEmailValField(null);
    }
  ...
  return (
    <div class="tabs-content">
      {spiner}
      <div class="h-100">
        <nav class="d-md-block d-flex justify-content-between align-items-start">
          {/* Top Menu Tabs */}
          <ul class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#nav-password">
                Password
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#nav-university">
                Institution
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#nav-work">
                Work Experience
              </a>
            </li>
          </ul>
        ...
        <div class="tab-content" id="nav-tabContent">
              ...
              <form onSubmit={saveProfileInfo}>
                <div class="form-group">
                  ...
                  <input
                    id="full_name"
                    type="text"
                    class="first-input input form-control"
                    name="full_name"
                    value={profileModel.full_name}
                  ...
                  />
                  {fullNameValField ? (
                    <ValidationMessage message={fullNameValField} />
                  ) : null}
                </div>
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="first-input input form-control"
                    name="city"
                    value={profileModel.city}
                    onChange={(event) => handleProfileInfoChange(event)}
                    required
                    autocomplete="name"
                  />
                  {cityValField ? (
                    <ValidationMessage message={cityValField} />
                  ) : null}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input
                    id="email"
                    type="text"
                    class="input disabled-input form-control"
                    name="email"
                  ...
                  />
                  {emailValField ? (
                    <ValidationMessage message={emailValField} />
                  ) : null}
                </div>
                <div class="upload-img d-flex justify-content-between flex-column flex-sm-row">
              ...
              <form id="work_experience" onSubmit={saveChangePassword}>
                <div class="form-group">
                  ...
                  <input
                    id="password"
                    type="password"
                    class="first-input form-control input"
                    name="oldPassword"
                    required
                    autofocus
          ...
          >
            <div class="table-responsive">
              <table class="text-center experience-table">
                <thead>
                  <tr>
            ...
            <div class="input-container" id="experience">
              <form id="academic_experience">
                ...
                <div>
                  ...
                  <div class="d-flex justify-content-between dates flex-column flex-sm-row">
                    <div class="form-group">
                      <input
                        id="from2"
                        type="date"
                        max="2100-12-31"
                        class="input form-control datapicker"
                        name="studyFromDate"
